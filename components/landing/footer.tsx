...
const socials = [
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/taqneo",
    icon: (
      <svg viewBox="0 0 24 24" className="size-3.5 fill-current">
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/taqneo",
    icon: (
      <svg viewBox="0 0 24 24" className="size-3.5 fill-current">
  ...
  {
    name: "Snapchat",
    href: "https://www.snapchat.com/@taqneo",
    icon: (
      <svg viewBox="0 0 24 24" className="size-3.5 fill-current">
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/taqne0/",
    icon: (
      <svg viewBox="0 0 24 24" className="size-3.5 fill-current">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@taqneo",
    icon: (
      <svg viewBox="0 0 24 24" className="size-3.5 fill-current">
