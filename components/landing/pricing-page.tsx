...
const individualPlans = [
  {
    ...
    features: [
      ...
      "Buy physical cards at full material price",
  ...
  },
  {
    ...
    period: "/year",
    description: "Unlock everything. No limits, no extra charges.",
    cta: "Upgrade to Pro",
    href: "/sign-up",
    ...
    features: [
      ...
      "All premium NEO ID Designs included",
      "All premium NEO Card Designs included",
      "Buy physical cards at full material price",
...
const companyPlans = [
  {
    ...
    features: [
      ...
      "Wood/Metal cards at upgrade price only",
  ...
  },
  {
    ...
    features: [
      "100+ seats (custom)",
      "Free Classic PVC card per seat",
      "All NEO ID + NEO Card Designs included",
  ...
  const materials = [
    {
      ...
      image: "/neo-cards/materials-base/classic/front.svg",
    },
    {
      name: "Artisan",
      ...
      image: "/neo-cards/materials-base/artisan/front.svg",
    },
    {
      name: "Prestige",
      ...
      image: "/neo-cards/materials-base/prestige/front.svg",
    },
  ];
